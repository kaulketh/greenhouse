...
* [greenhouse_lib_german.py](bot/lib/greenhouse_lib_german.py) - file with constants, contains strings for descriptions and messages
* [ext_greenhouse.py](bot/ext_greenhouse.py) - extended bot
* [ext_greenhouse_lib.py](bot/lib/ext_greenhouse_lib.py) - some constants, contains strings for commands and texts
* [greenhouse_lib_english.py](bot/lib/greenhouse_lib_english.py) - if required, same like German version, if used adapt imports!
