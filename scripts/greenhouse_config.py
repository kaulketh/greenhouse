...
# camera commands
enable_camera = 'sudo modprobe bcm2835-v4l2 && sleep 3 && sudo service motion start & '
disable_camera = 'sudo service motion stop && sleep 3 && sudo modprobe -r bcm2835-v4l2 && sudo rm -r /home/pi/Monitor/* &'
