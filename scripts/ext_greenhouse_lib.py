...
msg_help = 'Usage and possible commands in special mode:{0}{1} - this info{0}{2} - restart the whole RSBPi{0}{3} - ' \
           'force update{0}{4} - force archiving and cleaning of log files{0}{5} - stop this mode and restart default ' \
           ...
           'group 3 off{0}{14} - Live stream'.format(
            newline, cmd_help, cmd_restart, cmd_update, cmd_logrotate, cmd_kill, cmd_all_on, cmd_all_off, cmd_group1_on, cmd_group1_off, 
            cmd_group2_on, cmd_group2_off, cmd_group3_on, cmd_group3_off, cmd_live)
