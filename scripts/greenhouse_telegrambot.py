...
def start(bot, update):
    ...
    if user_id not in LIST_OF_ADMINS:
        ...
        dht.getValues()
        update.message.reply_text((lib.temperature + ': '+ conf.temp_format + lib.empty + 
                                   lib.humidity + ': ' + conf.hum_format).format(dht.temperature, dht.humidity), parse_mode=ParseMode.MARKDOWN)
